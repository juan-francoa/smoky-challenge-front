...
export default function Navbar() {
    return (
        ...
        <div className="d-flex">
            ...
            <div className="container-fluid nav-div-container d-flex justify-content-center">
        ...
        <div className="user-logo-container d-flex justify-content-end img-fluid">
            <p ><Link to={"/signin"}> <img className="user-logo" src="img/usuario.png" alt="user logo"/></Link></p>
