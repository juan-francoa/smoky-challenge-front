                        ...
                        <div className="card2">
                            <div className="card3">
                                ...
                                <form className="d-flex justify-content-center flex-column gap-3">
                                    ...
                                    <div className="field">
                                        <img className="input-icon" src="img/name.png" />
                                        <InputGral autocomplete="off" id="logpass" type='text' placeholder='Lastname' refId={lastName} inputClass="input-field" />
                                    </div>

                                    <div className="field">
                                        <img className="input-icon" src="img/age.png" />
                                        <InputGral autocomplete="off" id="logpass" type='number' placeholder='Age' refId={age} inputClass="input-field" />
                                    </div>
                                    <div className="field">
                                        <img className="input-icon" src="img/link.png" />
                                        <InputGral autocomplete="off" id="logpass" type='text' placeholder='URL photo' refId={photo} inputClass="input-field" />
                                    </div>
                                    ...
                                    <ButtonSubmit type='submit' text='Create' fx={enviarFormulario} btnClass="btn" />
                                </form>
                            </div>
                        </div>
                    </div>
